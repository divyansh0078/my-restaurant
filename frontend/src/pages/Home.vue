    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <h3>Graphians Taco — Where Mexican Magic Meets Dehradun Warmth.😋</h3>
                <p>Enjoy the vibrant Mexican ambiance in our restaurant or get your favorites delivered straight to your doorstep. With flavor, freshness, and fun in every order, Graphians Taco is here to spice up your day.</p>
        ...
        <div class="home-about">
            ...
            <div class="content">
                ...
                <h3 class="title">Why Choose Us? What Makes Our Food Truly Delicious!</h3>
                <p>We bring the heart of authentic Mexican cuisine to Dehradun, offering dishes that are bursting with bold, unforgettable flavors. Every plate is a celebration of traditional recipes and high-quality ingredients, prepared with care and creativity. Backed by the excellence and innovation of Graphic Era, our restaurant is committed to maintaining the highest standards in food quality, hygiene, and service. Whether you’re dining in or ordering for delivery, we ensure a flavorful, satisfying experience that captures the true spirit of Mexico.</p>
